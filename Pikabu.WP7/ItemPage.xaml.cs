    ...
    public partial class ItemPage : PhoneApplicationPage
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            //if (e.NavigationMode == NavigationMode.New)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    BugSense.BugSenseHandler.Instance.SendException(ex);
                }
                finally
                {
        ...
        private void SetEnabledForAppBar(Story story)
        {
            ...
            catch (Exception ex)
            {
                ...
                BugSense.BugSenseHandler.Instance.SendExceptionMessage("i", i.ToString(), ex);
            }
        }
        ...
        private void GoBack()
        {
            ...
            {
                MessageBox.Show("Возникла ошибка:(");
                BugSense.BugSenseHandler.Instance.SendExceptionMessage("type", "gobackonline", ex);
            }
        }
        ...
        private void GoForward()
        {
            ...
            {
                MessageBox.Show("Возникла ошибка:(");
                BugSense.BugSenseHandler.Instance.SendExceptionMessage("type", "goforwardonline", ex);
            }
        }
        ...
        private void Favorite_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Возникла ошибка:(");
                BugSense.BugSenseHandler.Instance.SendExceptionMessage("type", "addtofav", ex);
            }
        }
